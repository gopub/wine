...
func (r *Router) UseHandlers(handlers ...Handler) *Router {
	nr := r.Router.Use(linkHandlers(handlers))
	return &Router{
		Router:      nr,
		authHandler: r.authHandler,
	}
...
func (r *Router) Use(funcs ...HandlerFunc) *Router {
	nr := r.Router.Use(linkHandlerFuncs(funcs))
	return &Router{
		Router:      nr,
		authHandler: r.authHandler,
	}
