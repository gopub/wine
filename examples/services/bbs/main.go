...
func main() {
	...
	s.Get("login", func(ctx context.Context, req *wine.Request, next wine.Invoker) wine.Responder {
	...
	s.Post("topic", func(ctx context.Context, req *wine.Request, next wine.Invoker) wine.Responder {
